...
struct MockData {
    static let sampleDish = Dish(price: 9.99, name: "Sample Dish", description: "This is the description for my dish. It's yummy.", imageURL: "carbonara.jpeg", id: 0, calories: 99, grams: 99)
